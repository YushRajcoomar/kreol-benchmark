...
PRETRAIN=${BASEDIR}\\mbart50.ft.nn\\mbart50.ft.nn
langs=${BASEDIR}\\mbart50.ft.nn\\mbart50.ft.nn\\ML50_langs.txt
SRC=en
TGT=cr
NAME=en-cr
...
python ${FAIRSEQ}\\train.py ${DATADIR}  --encoder-normalize-before --decoder-normalize-before  --arch mbart_large \
...
--keep-interval-updates 10 --no-epoch-checkpoints --seed 222 --log-format simple --log-interval 2 --reset-optimizer \
